...
public class twitter_sign_in extends AppCompatActivity implements View.OnClickListener{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(twitter_sign_in.this, "Authentication failed.",
    ...
    public void showProgressDialog() {
        this.dialog = new ProgressDialog(twitter_sign_in.this);
