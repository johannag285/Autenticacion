...
public class facebook_sign_in extends AppCompatActivity implements View.OnClickListener{
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(facebook_sign_in.this, "Authentication failed.",
    ...
    public void showProgressDialog() {
        this.dialog = new ProgressDialog(facebook_sign_in.this);
